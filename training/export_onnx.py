...
def get_args():
    ...
    parser.add_argument('--output-path', type=str, default='doc_orientation.onnx', help="Path to save ONNX model")
...
def main():
    ...
    # Create dummy input
    # Dynamic batch size, 3 channels, 224x224
    ...
    print(f"ONNX model saved! Size: {file_size_mb:.2f} MB")
